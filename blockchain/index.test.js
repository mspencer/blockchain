...
describe('Blockchain', () => {
    let blockchain, newblockchain, originalchain; // use let so it can be reassigned

    beforeEach(() => { // means before each test, create a new blockchain as below. so every tests use a fresh, un-tampering blockchain
